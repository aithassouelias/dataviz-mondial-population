window.addEventListener('load', () => {
	...
	death.getDeathsValuesMaleByYearContinent('Africa').then((deaths) => {
		yearsGroupedMale = death.groupValueByColumn("year", deaths);
		return death.getDeathsValuesFemaleByYearContinent('Africa');
	}).then((deaths) =>{
	...
	death.getDeathsValuesMaleByAgeContinent('Africa').then((deaths) => {
		ageGroupedMale = death.groupValueByColumn("age_group", deaths);
		return death.getDeathsValuesFemaleByAgeContinent('Africa');
	}).then((deaths) =>{
	...
	death.getDeathsValuesContinent('Africa').then((deaths) => {
	...
	death.getDeathsValuesFemaleContinent('Africa').then((deaths) => {
	...
	death.getDeathsValuesMaleContinent('Africa').then((deaths) => {
