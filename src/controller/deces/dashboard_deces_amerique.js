window.addEventListener('load', () => {
	...
	death.getDeathsValuesMaleByYearContinent('America').then((deaths) => {
		yearsGroupedMale = death.groupValueByColumn("year", deaths);
		return death.getDeathsValuesFemaleByYearContinent('America');
	}).then((deaths) =>{
	...
	death.getDeathsValuesMaleByAgeContinent('America').then((deaths) => {
		ageGroupedMale = death.groupValueByColumn("age_group", deaths);
		return death.getDeathsValuesFemaleByAgeContinent('America');
	}).then((deaths) =>{
	...
	death.getDeathsValuesContinent('America').then((deaths) => {
	...
	death.getDeathsValuesFemaleContinent('America').then((deaths) => {
	...
	death.getDeathsValuesMaleContinent('America').then((deaths) => {
