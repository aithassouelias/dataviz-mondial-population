window.addEventListener('load', () => {
	...
	death.getDeathsValuesMaleByYearContinent('Europe').then((deaths) => {
		yearsGroupedMale = death.groupValueByColumn("year", deaths);
		return death.getDeathsValuesFemaleByYearContinent('Europe');
	}).then((deaths) =>{
	...
	death.getDeathsValuesMaleByAgeContinent('Europe').then((deaths) => {
		ageGroupedMale = death.groupValueByColumn("age_group", deaths);
		return death.getDeathsValuesFemaleByAgeContinent('Europe');
	}).then((deaths) =>{
	...
	death.getDeathsValuesContinent('Europe').then((deaths) => {
	...
	death.getDeathsValuesFemaleContinent('Europe').then((deaths) => {
	...
	death.getDeathsValuesMaleContinent('Europe').then((deaths) => {
