window.addEventListener('load', () => {
	...
	death.getDeathsValuesMaleByYearContinent('Oceania').then((deaths) => {
		yearsGroupedMale = death.groupValueByColumn("year", deaths);
		return death.getDeathsValuesFemaleByYearContinent('Oceania');
	}).then((deaths) =>{
	...
	death.getDeathsValuesMaleByAgeContinent('Oceania').then((deaths) => {
		ageGroupedMale = death.groupValueByColumn("age_group", deaths);
		return death.getDeathsValuesFemaleByAgeContinent('Oceania');
	}).then((deaths) =>{
	...
	death.getDeathsValuesContinent('Oceania').then((deaths) => {
	...
	death.getDeathsValuesFemaleContinent('Oceania').then((deaths) => {
	...
	death.getDeathsValuesMaleContinent('Oceania').then((deaths) => {
