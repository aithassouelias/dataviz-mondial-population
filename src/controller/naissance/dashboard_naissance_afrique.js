window.addEventListener('load', () => {
  ...
  birth.getBirthsValuesByYearContinent('Africa').then((births) => {
  ...
  birth.getBirthsByBankIncomeContinent('Africa').then((births) => {
  ...
  birth.getBirthsByCountryContinent('Africa').then((births) => {
  ...
  birth.getBirthsValuesContinent('Africa').then((births) => {
