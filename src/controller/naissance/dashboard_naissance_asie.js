window.addEventListener('load', () => {
    ...
    birth.getBirthsValuesByYearContinent('Asia').then((births) => {
    ...
    birth.getBirthsByBankIncomeContinent('Asia').then((births) => {
    ...
    birth.getBirthsByCountryContinent('Asia').then((births) => {
    ...
    birth.getBirthsValuesContinent('Asia').then((births) => {
