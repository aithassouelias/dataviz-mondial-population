window.addEventListener('load', () => {
    ...
    birth.getBirthsValuesByYearContinent('Europe').then((births) => {
    ...
    birth.getBirthsByBankIncomeContinent('Europe').then((births) => {
    ...
    birth.getBirthsByCountryContinent('Europe').then((births) => {
    ...
    birth.getBirthsValuesContinent('Europe').then((births) => {
