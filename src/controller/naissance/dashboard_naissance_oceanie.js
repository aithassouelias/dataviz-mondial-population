window.addEventListener('load', () => {
    ...
    birth.getBirthsValuesByYearContinent('Oceania').then((births) => {
    ...
    birth.getBirthsByBankIncomeContinent('Oceania').then((births) => {
    ...
    birth.getBirthsByCountryContinent('Oceania').then((births) => {
    ...
    birth.getBirthsValuesContinent('Oceania').then((births) => {
